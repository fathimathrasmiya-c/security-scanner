...
"""
    ...
    def _parse_response(
        ...
        diff_summary = self._extract_section(response_text, "DIFF_SUMMARY:")
        confidence = self._extract_section(response_text, "CONFIDENCE:") or "medium"

        # Clean up
        fixed_code = fixed_code.strip() or original_code
        explanation = explanation.strip() or "Fix generated by AI"
        diff_summary = diff_summary.strip() or "Code remediation"
